...
typedef struct st_adc_api
{
     ...
     * - @ref R_ADC_E_ScanStart()
     * - @ref R_TSU_B_ScanStart()
     *
     * @param[in]  p_ctrl   Pointer to control handle structure
     */
     ...
     * - @ref R_ADC_E_ScanGroupStart()
     * - @ref R_TSU_B_ScanGroupStart()
     *
     * @param[in]  p_ctrl     Pointer to control handle structure
     ...
     * - @ref R_ADC_E_StatusGet()
     * - @ref R_TSU_B_StatusGet()
     *
     * @param[in]  p_ctrl   Pointer to control handle structure
     ...
     * - @ref R_ADC_E_Calibrate()
     * - @ref R_TSU_B_Calibrate()
     *
     * @param[in]  p_ctrl    Pointer to control handle structure
     ...
     * - @ref R_ADC_E_OffsetSet()
     * - @ref R_TSU_B_OffsetSet()
     *
     * @param[in]  p_ctrl    Pointer to control handle structure
     * @param[in]  reg_id    ADC channel to read (see enumeration adc_channel_t)
     ...
     * - @ref R_ADC_E_CallbackSet()
     * - @ref R_TSU_B_CallbackSet()
     *
